...
impl SailVirtCtx {
    pub fn new() -> Self {
        SailVirtCtx {
            ...
            misa: BitField { bits: BitVector { bits: 0 } },
            mstatush: BitField { bits: BitVector { bits: 0 } },
            mstatus: BitField { bits: BitVector { bits: 0 } },
            mip: BitField { bits: BitVector { bits: 0 } },
            mie: BitField { bits: BitVector { bits: 0 } },
            mideleg: BitField { bits: BitVector { bits: 0 } },
            medeleg: BitField { bits: BitVector { bits: 0 } },
            mtvec: BitField { bits: BitVector { bits: 0 } },
            mcause: BitField { bits: BitVector { bits: 0 } },
            mepc: BitVector {bits: 0},
            mtval: BitVector {bits: 0},
            mscratch: BitVector {bits: 0},
            mcounteren: BitField { bits: BitVector { bits: 0 } },
            scounteren: BitField { bits: BitVector { bits: 0 } },
            mcountinhibit: BitField { bits: BitVector { bits: 0 } },
            ...
            sedeleg: BitField { bits: BitVector { bits: 0 } },
            sideleg: BitField { bits: BitVector { bits: 0 } },
            stvec: BitField { bits: BitVector { bits: 0 } },
            sscratch: BitVector {bits: 0},
            sepc: BitVector {bits: 0},
            scause: BitField { bits: BitVector { bits: 0 } },
            stval: BitVector {bits: 0},
            tselect: BitVector {bits: 0},
            menvcfg: BitField { bits: BitVector { bits: 0 } },
            senvcfg: BitField { bits: BitVector { bits: 0 } },
            vstart: BitVector {bits: 0},
            vxsat: BitVector {bits: 0},
            vxrm: BitVector {bits: 0},
            vl: BitVector {bits: 0},
            vlenb: BitVector {bits: 0},
            vtype: BitField { bits: BitVector { bits: 0 } },
            pmpcfg_n: [BitField{bits : BitVector {bits: 0}}; 64],
            ...
            vcsr: BitField { bits: BitVector { bits: 0 } },
            utvec: BitField { bits: BitVector { bits: 0 } },
            uscratch: BitVector {bits: 0},
            uepc: BitVector {bits: 0},
            ucause: BitField { bits: BitVector { bits: 0 } },
            ...
            fcsr: BitField { bits: BitVector { bits: 0 } },
...
pub struct SailVirtCtx {
    elen: BitVector<1>,
    vlen: BitVector<4>,
    __monomorphize_reads: bool,
    __monomorphize_writes: bool,
    pub(crate) PC: xlenbits,
    pub(crate) nextPC: xlenbits,
    instbits: xlenbits,
    x1: regtype,
    x2: regtype,
    x3: regtype,
    ...
    x30: regtype,
    x31: regtype,
    pub(crate) cur_privilege: Privilege,
    cur_inst: xlenbits,
    misa: Misa,
    mstatush: Mstatush,
    ...
    tlb: Option<TLB_Entry>,
    satp: xlenbits,
}

fn hex_bits_forwards<const N: usize>(sail_ctx: &mut SailVirtCtx, bv: BitVector<N>) -> (usize, String) {
...
fn _operator_smaller_s_<const N: usize>(sail_ctx: &mut SailVirtCtx, x: BitVector<N>, y: BitVector<N>) -> bool {
    (signed(x) < signed(y))
}

fn _operator_smaller_u_<const N: usize>(sail_ctx: &mut SailVirtCtx, x: BitVector<N>, y: BitVector<N>) -> bool {
    (x.as_usize() < y.as_usize())
}

fn _operator_smallerequal_u_<const N: usize>(sail_ctx: &mut SailVirtCtx, x: BitVector<N>, y: BitVector<N>) -> bool {
    lteq_int(x.as_usize(), y.as_usize())
}

fn _operator_biggerequal_u_<const N: usize>(sail_ctx: &mut SailVirtCtx, x: BitVector<N>, y: BitVector<N>) -> bool {
    (x.as_usize() >= y.as_usize())
}
...
fn privLevel_of_bits(sail_ctx: &mut SailVirtCtx, p: BitVector<2>) -> Privilege {
    match p {
        ...
        _ => {internal_error(String::from("../sail-riscv/model/riscv_types.sail"), 111, format!("{}{}", String::from("Invalid privilege level: "), bits_str(p)))}
    }
}
...
fn satp64Mode_of_bits(sail_ctx: &mut SailVirtCtx, a: Architecture, m: BitVector<4>) -> Option<SATPMode> {
    match (a, m) {
...
fn wX(sail_ctx: &mut SailVirtCtx, r: usize, in_v: BitVector<64>) {
    ...
    match r {
        ...
        30 => {sail_ctx.x30 = v}
        31 => {sail_ctx.x31 = v}
        _ => {assert!(false, "todo_process_message")}
    };
    if {(r != 0)} {
...
fn cur_Architecture(sail_ctx: &mut SailVirtCtx, unit_arg: ()) -> Architecture {
    ...
    match architecture(sail_ctx, a) {
        Some(a) => {a}
        None => {internal_error(String::from("../sail-riscv/model/riscv_sys_regs.sail"), 323, String::from("Invalid current architecture"))}
    }
}
...
fn _update_Minterrupts_MEI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
...
fn _update_Minterrupts_MSI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 3, 3, x)
    }
}
...
fn _update_Minterrupts_MTI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
...
fn _update_Minterrupts_SEI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
...
fn _update_Minterrupts_SSI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 1, 1, x)
    }
}
...
fn _update_Minterrupts_STI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 5, 5, x)
    }
}
...
fn _update_Minterrupts_UEI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 8, 8, x)
    }
}
...
fn _update_Minterrupts_USI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 0, 0, x)
    }
}
...
fn _update_Minterrupts_UTI(sail_ctx: &mut SailVirtCtx, v: Minterrupts, x: BitVector<1>) -> Minterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 4, 4, x)
    }
}
...
fn legalize_mideleg(sail_ctx: &mut SailVirtCtx, o: Minterrupts, v: BitVector<64>) -> Minterrupts {
    {
        let var_63 = {
            let var_65 = {
                let var_67 = Mk_Minterrupts(sail_ctx, v);
...
fn _update_Sinterrupts_SEI(sail_ctx: &mut SailVirtCtx, v: Sinterrupts, x: BitVector<1>) -> Sinterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 9, 9, x)
    }
}
...
fn _update_Sinterrupts_SSI(sail_ctx: &mut SailVirtCtx, v: Sinterrupts, x: BitVector<1>) -> Sinterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 1, 1, x)
    }
}
...
fn _update_Sinterrupts_STI(sail_ctx: &mut SailVirtCtx, v: Sinterrupts, x: BitVector<1>) -> Sinterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 5, 5, x)
    }
}
...
fn _update_Sinterrupts_UEI(sail_ctx: &mut SailVirtCtx, v: Sinterrupts, x: BitVector<1>) -> Sinterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 8, 8, x)
    }
}
...
fn _update_Sinterrupts_USI(sail_ctx: &mut SailVirtCtx, v: Sinterrupts, x: BitVector<1>) -> Sinterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 0, 0, x)
    }
}
...
fn _update_Sinterrupts_UTI(sail_ctx: &mut SailVirtCtx, v: Sinterrupts, x: BitVector<1>) -> Sinterrupts {
    BitField {
        bits: update_subrange_bits(v.bits, 4, 4, x)
    }
}
...
fn lift_sip(sail_ctx: &mut SailVirtCtx, o: Minterrupts, d: Minterrupts, s: Sinterrupts) -> Minterrupts {
    let m: Minterrupts = o;
...
fn legalize_sip(sail_ctx: &mut SailVirtCtx, m: Minterrupts, d: Minterrupts, v: BitVector<64>) -> Minterrupts {
    {
        let var_191 = m;
        let var_192 = d;
...
fn lift_sie(sail_ctx: &mut SailVirtCtx, o: Minterrupts, d: Minterrupts, s: Sinterrupts) -> Minterrupts {
    let m: Minterrupts = o;
...
fn legalize_sie(sail_ctx: &mut SailVirtCtx, m: Minterrupts, d: Minterrupts, v: BitVector<64>) -> Minterrupts {
    {
        let var_206 = m;
        let var_207 = d;
...
fn legalize_satp64(sail_ctx: &mut SailVirtCtx, a: Architecture, o: BitVector<64>, v: BitVector<64>) -> BitVector<64> {
...
fn legalize_satp32(sail_ctx: &mut SailVirtCtx, a: Architecture, o: BitVector<32>, v: BitVector<32>) -> BitVector<32> {
    v
}
...
fn pmpWriteCfg(sail_ctx: &mut SailVirtCtx, n: usize, cfg: Pmpcfg_ent, v: BitVector<8>) -> Pmpcfg_ent {
...
fn pmpWriteAddr(sail_ctx: &mut SailVirtCtx, locked: bool, tor_locked: bool, reg: BitVector<64>, v: BitVector<64>) -> BitVector<64> {
    if {(64 == 32)} {
        panic!("unreachable code")
    } else {
...
fn ext_check_CSR(sail_ctx: &mut SailVirtCtx, csrno: BitVector<12>, p: Privilege, isWrite: bool) -> bool {
    true
}
...
fn handle_trap_extension(sail_ctx: &mut SailVirtCtx, p: Privilege, pc: BitVector<64>, u: Option<()>) {
    ()
}
...
fn prepare_trap_vector(sail_ctx: &mut SailVirtCtx, p: Privilege, cause: Mcause) -> BitVector<64> {
    ...
    match tvec_addr(sail_ctx, tvec, cause) {
        Some(epc) => {epc}
        None => {internal_error(String::from("../sail-riscv/model/riscv_sys_exceptions.sail"), 29, String::from("Invalid tvec mode"))}
    }
}
...
fn set_xret_target(sail_ctx: &mut SailVirtCtx, p: Privilege, value: BitVector<64>) -> BitVector<64> {
...
fn ext_write_CSR(sail_ctx: &mut SailVirtCtx, _: BitVector<12>, _: BitVector<64>) -> Option<BitVector<64>> {
    None
}
...
fn check_CSR_access(sail_ctx: &mut SailVirtCtx, csrrw: BitVector<2>, csrpr: BitVector<2>, p: Privilege, isWrite: bool) -> bool {
...
fn check_seed_CSR(sail_ctx: &mut SailVirtCtx, csr: BitVector<12>, p: Privilege, isWrite: bool) -> bool {
