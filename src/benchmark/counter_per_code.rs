...
pub struct CounterPerCodeBenchmark {}
...
impl BenchmarkModule for CounterPerCodeBenchmark {
    fn init() -> Self {
        CounterPerCodeBenchmark {}
    }
    ...
    fn get_counter_value(_hart_id: usize, _counter: Counter) -> usize {
        todo!("Implement the get_counter_value logic in counter_per_code")
    }
}
