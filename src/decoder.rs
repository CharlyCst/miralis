...
impl MiralisContext {
    ...
    pub fn decode_illegal_instruction(&self, raw_instr: usize) -> IllegalInstruction {
        assert_eq!(
            raw_instr & 0b1111111,
            ILLEGAL_OPCODE_MASK,
        ...
        match raw_instr {
            0b00010000010100000000000001110011 => return IllegalInstruction::Wfi,
            0b00110000001000000000000001110011 => return IllegalInstruction::Mret,
            0b00010000001000000000000001110011 => return IllegalInstruction::Sret,
            _ => {}
        }
        ...
        match raw_instr & !RS1_RS1_INSTR_TYPE_MASK {
            SFENCE_INSTR_VMA_MASK => return IllegalInstruction::Sfencevma { rs1, rs2 },
            HFENCE_INSTR_VVMA_MASK => return IllegalInstruction::Hfencevvma { rs1, rs2 },
            HFENCE_INSTR_GVMA_MASK => return IllegalInstruction::Hfencegvma { rs1, rs2 },
            _ => {}
        }
        ...
        match raw_instr & FUNC3_MASK {
            0x1000 => IllegalInstruction::Csrrw { csr, rd, rs1 },
            0x2000 => IllegalInstruction::Csrrs { csr, rd, rs1 },
            0x3000 => IllegalInstruction::Csrrc { csr, rd, rs1 },
            0x5000 => IllegalInstruction::Csrrwi { csr, rd, uimm },
            0x6000 => IllegalInstruction::Csrrsi { csr, rd, uimm },
            0x7000 => IllegalInstruction::Csrrci { csr, rd, uimm },
