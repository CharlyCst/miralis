...
impl MiralisContext {
    /// Decodes a raw load/store RISC-V instruction.
    pub fn decode_load_store(&self, raw: usize) -> Instr {
    ...
    /// Decodes the system instructions
    pub fn decode_system(&self, raw: usize) -> Instr {
...
mod tests {
    ...
    fn system_instructions() {
        ...
        assert_eq!(mctx.decode_system(0x10200073), Instr::Sret);
        // WFI: Wait for interrupt.
        assert_eq!(mctx.decode_system(0x10500073), Instr::Wfi);
        // SFENCE.VMA: Supervisor memory-management fence.
        assert_eq!(
            mctx.decode_system(0x12000073),
            Instr::Sfencevma {
                rs1: Register::X0,
                rs2: Register::X0
            }
    ...
    fn access_instructions() {
        ...
        assert_eq!(
            mctx.decode_load_store(0xff87b703),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xfee7bc23),
            Instr::Store {
                rs2: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xff87a703),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xfee7ac23),
            Instr::Store {
                rs2: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xff879703),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xfee79c23),
            Instr::Store {
                rs2: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xff878703),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xfee78c23),
            Instr::Store {
                rs2: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xffffe798),
            Instr::Store {
                rs2: Register::X14,
                rs1: Register::X15,
                imm: 64,
        ...
        assert_eq!(
            mctx.decode_load_store(0xffff6798),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: 64,
        ...
        assert_eq!(
            mctx.decode_load_store(0xffff4798),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: 32,
        ...
        assert_eq!(
            mctx.decode_load_store(0xffffc798),
            Instr::Store {
                rs2: Register::X14,
                rs1: Register::X15,
                imm: 32,
        ...
        assert_eq!(
            mctx.decode_load_store(0xff87e703),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xff87d703),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: -8,
        ...
        assert_eq!(
            mctx.decode_load_store(0xff87c703),
            Instr::Load {
                rd: Register::X14,
                rs1: Register::X15,
                imm: -8,
