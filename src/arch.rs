...
_enter_virt_firmware:
    ...
    ld x1,(8*1)(x31)        // Load guest general purpose registers
    ld x2,(8*2)(x31)
    ld x3,(8*3)(x31)
    ld x4,(8*4)(x31)
    ld x5,(8*5)(x31)
...
_raw_trap_handler:
    ...
    sd x1,(8*1)(x31)         // Save all general purpose registers
    sd x2,(8*2)(x31)
    sd x3,(8*3)(x31)
    sd x4,(8*4)(x31)
    sd x5,(8*5)(x31)
    ...
    sd x30,(8*31)(x31)  // Save x31 (whose value is stored in x30)
