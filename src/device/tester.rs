...
/// Devices and drivers are used to communicate with the external world and therefore produce non-deterministic events.
/// This makes testing a virtual device interface harder. This structure creates a determinist driver.
#[derive(Debug)]
