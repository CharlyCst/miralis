...
impl PolicyModule for KeystonePolicy {
    ...
    fn switch_from_payload_to_firmware(&mut self, _ctx: &mut VirtContext, _mctx: &mut MiralisContext) {
        // TODO: Implement
    }

    fn switch_from_firmware_to_payload(&mut self, _ctx: &mut VirtContext, _mctx: &mut MiralisContext) {
        // TODO: Implement
    }
